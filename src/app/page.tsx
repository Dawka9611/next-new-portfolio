    ...
    <div className="flex flex-col h-[fit-content] items-center justify-between relative">
      <div className='flex items-center justify-between w-full gap-3'>
        ...
        <div className='w-1/2 flex flex-col items-start justify-center h-auto'>
          ...
          <div className='text-syan text-3xl font-bold py-3'>
            <TypeWriter />
          </div>
          ...
          <div className='flex items-center self-start mt-2 gap-10'>
            <Link href='cv.pdf'
              target={"_blank"}
              className='flex items-center gap-2 bg-white text-dark p-2.5 px-6 rounded-lg text-lg font-semibold transition hover:bg-syan'
              download={true}>
              {translations.resume}
            ...
            <Link href='mailto:udawaadulam9611@gmail.com'
              target={"_blank"}
              className='text-lg font-medium text-white underline transition hover:text-syan'>
